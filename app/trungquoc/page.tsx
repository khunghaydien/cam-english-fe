...
const Plus = ({ value }: PlusProps) => {
  return (
    <div className="font-bahn flex items-center justify-center bg-black opacity-[27%] rounded-[34px] w-[171px] h-[64px] py-[10px] px[11px] gap-[19px]">
...
const Body = () => {
  return (
    <div className="relative font-bahn">
      <div
        style={{
...
const Notification = () => {
  return (
    <div className="flex items-center justify-center w-screen font-bahn">
      <div>
...
export default function Home() {
  return (
    <div className="bg-[#18181b] relative font-bahn">
